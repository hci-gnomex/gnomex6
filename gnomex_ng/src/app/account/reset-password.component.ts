    ...
    public submit(): void {
        this.passwordUtilService.resetPassword(this.checkByUsername, this.inputFC.value).subscribe((result: any) => {
            if (result && result.result && result.result === 'SUCCESS') {
                this.dialogsService.confirm("Instructions on how to change your password have been emailed to you", null);
                ...
                this.dialogsService.confirm("An error occurred while resetting your password" + message, null);
            }
        });
    }
