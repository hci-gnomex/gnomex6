...
@Component({
    selector: 'browse-filter-basic',
    templateUrl: "./browse-filter-basic.component.html",
    styles: [`
...
export class BrowseFilterBasicComponent implements OnInit, OnDestroy, OnChanges {
