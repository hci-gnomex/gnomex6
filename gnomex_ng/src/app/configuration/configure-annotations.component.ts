...
export class ConfigureAnnotationsComponent {
    ...
    private updateDisplayedProperties(): void {
        this.annotGridRowData = this.allProps.filter((prop: any) => {
            ...
            if (this.type === "") {
                criteriaMatch = true;
            } else if (this.type === this.SHOW_FOR_SAMPLES && prop.forSample === "Y") {
                criteriaMatch = true;
            } else if (this.type === this.SHOW_FOR_ANALYSIS && prop.forAnalysis === "Y") {
                criteriaMatch = true;
            } else if (this.type === this.SHOW_FOR_DATA_TRACKS && prop.forDataTrack === "Y") {
                criteriaMatch = true;
            } else if (this.type === this.SHOW_FOR_EXPERIMENTS && prop.forRequest === "Y") {
                criteriaMatch = true;
            }
            if (!criteriaMatch) {
                return false;
    ...
    public add(): void {
        ...
        newProp.sortOrder = "";
        newProp.forSample = this.type === this.SHOW_FOR_SAMPLES ? "Y" : "N";
        newProp.forDataTrack = this.type === this.SHOW_FOR_DATA_TRACKS ? "Y" : "N";
        newProp.forAnalysis = this.type === this.SHOW_FOR_ANALYSIS ? "Y" : "N";
        newProp.forRequest = this.type === this.SHOW_FOR_EXPERIMENTS ? "Y" : "N";
