...
export class EpExperimentTypeIlluminaTabComponent implements OnInit, OnDestroy{
    ...
    onGridReady(params:any){
        ...
        this.expPlatformSubscription = this.expPlatfromService.getExperimentPlatformObservable().subscribe(data =>{
            if(data && data.applications ){
                ...
                let unrefinedApps = (Array.isArray(data.applications) ? data.applications : [data.applications.Application]);
    ...
    flattenApplication(applications: any[]): any[]{
        let flatApps:any[] =[];
        applications.forEach(appObj => {
