    ...
    public Command execute() throws RollBackCommandException {
        ...
        try {
            ...
            if (this.getSecurityAdvisor().hasPermission(SecurityAdvisor.CAN_MANAGE_BILLING)) {
                ...
                PriceCategory priceCategory = sess.load(PriceCategory.class, idPriceCategorySource);
                String message = "";

                if (idPriceSheetTarget != null) {
                    PriceSheet priceSheet = sess.load(PriceSheet.class, idPriceSheetTarget);
                    ...
                    if (existingPriceCategory == null) {
                        ...
                        if (positionPriceCategory != null) {
                            x.setSortOrder(positionPriceCategory.getSortOrder() + 1);
                        } else {
