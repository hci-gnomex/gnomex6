...
public class ReportIssueServlet extends HttpServlet {
    ...
    private static final Logger LOG = Logger.getLogger(ReportIssueServlet.class);
            ...
            while ((part = mp.readNextPart()) != null) {
                ...
                if (part.isParam()) {
                    ...
                    try {
                        ...
                        LOG.error("Error in ReportIssueServlet", e);
...
System.out.println ("[ReportIssueServlet] emailRecipients: " + emailRecipients);
            // Email app user
            String emailBody;
            ...
            System.out.println ("[ReportIssueServlet] fromAddress: " + fromAddress);
            ...
            try {
                ...
                LOG.error("Error in ReportIssueServlet", e1);
            }
        }
