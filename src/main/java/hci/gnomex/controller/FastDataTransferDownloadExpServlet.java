    ...
    try {
      ...
      if (secAdvisor != null) {
        ...
        if(showCommandLineInstructions != null && showCommandLineInstructions.equals("Y")) {
          ...
          response.getOutputStream().println("<BR>4) There is a 24 hour timeout on this command.  After that time please generate a new command line using the FDT Download Command Line link.");
