...
public class JsonNavigator {
	...
	public int size() {
		return this.elementBuffer.count;
	}
...
//        return this.elementIndex > 0;
   ...
   public String typeAsString() {
        return ElementTypes.toString(this.elementBuffer.type[this.elementIndex]);
    }
    ...
    public String asStringDecoded() {

		// just return "" for object start/end and array start/end
		if (this.elementBuffer.type[this.elementIndex] <= 3 || this.elementBuffer.type[this.elementIndex] == 9) {
			return "";
		}
