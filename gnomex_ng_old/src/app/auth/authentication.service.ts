...
export class AuthenticationService {
    ...
    private _maxInactivityMinutes: number = 1440;
...
//       console.log ("exp: " + exp + " msToExpiry" + msToExpiry);
    ...
    getDuoSignRequest(username: string) {
        return this._http.get("/gnomex/api/duo/sign", { params: { username } });
    }

    verifyDuo(sig_response: string) {
        return this._http.post("/gnomex/api/duo/verify", { sig_response: sig_response });
    }
